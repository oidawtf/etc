...
class utils {
    ...
    public static function PrintSeatFree($seat, $event) {
    ...
    public static function PrintSeatSold($seat) {
    ...
    public static function PrintSeatReserved($seat, $event) {
    ...
    public static function PrintSeatBooked($seat, $event) {
